app.controller('admin.board.list', function($scope, $http){
  ...
  $scope.list = function () {
    ...
    $http.get('/notices?page=' + $scope.currentPage +'&rows=' + $scope.viewby +'&keyword=' + $scope.selected.keyword).then(function (res)  {

      console.log("$scope.selected.keyword", $scope.selected.keyword)
