app.controller('admin.cafe.list', function($scope, $http){
  ...
  $scope.list = function () {
    ...
    $http.get('/cafeinfos?page=' + $scope.currentPage +'&rows=' + $scope.viewby +'&keyword=' + $scope.selected.keyword ).then(function (res)  {
      console.log(res)
