app.controller('angelCafeProductAddCtrl', function($scope, $state, AngelProduct, $http, toastr){
  var vm = this;
  ...
  vm.add = function(item) {
    ...
    //   console.log("OK")
    //   $state.go('angeladmin.product.list')
    // }, function(err) {
    //   toastr.error(err.data);
    // })

    $http.post('/api/products', item).then(function (res) {
